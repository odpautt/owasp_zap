...
def zap_scan(target, apikey='njncqt4kno939oimgfje2rdldf', zap_port='8087', scan_type='full'):
    ...
    for each_vuln in results:
        ...
        tmp = {"issue_type": "vulnerability",
               ...
               'evidence': 'Method:' + each_vuln['method'] + ' Evidence:' + each_vuln['evidence'] + ' Parameters:' +
                           each_vuln['param'],
               'target': target,
